...
var oldExt = '.html',
    ...
    folders = [
        ...
        'src/components/templates/partials/multilingual/*',
        'src/components/templates/partials/multilingual/bahasa*',
        'src/components/templates/partials/multilingual/chinese*',
        'src/components/templates/partials/multilingual/english*',
        'src/components/templates/partials/multilingual/vietnamese*',
        'src/components/templates/partials/multilingual/thai*'
    ];
...
gulp.task('replace', function() {
    ...
    function replaceDelete() {
        del([
            ...
            'src/components/templates/partials/multilingual/*' + oldExt,
            'src/components/templates/partials/multilingual/bahasa*' + oldExt,
            'src/components/templates/partials/multilingual/chinese*' + oldExt,
            'src/components/templates/partials/multilingual/english*' + oldExt,
            'src/components/templates/partials/multilingual/vietnamese*' + oldExt,
            'src/components/templates/partials/multilingual/thai*' + oldExt
        ]);
        return gulp.src("./")
            .pipe(notify({
